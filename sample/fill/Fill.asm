...
(LOOP)	           //progresses the index backwards. 
	...
	D=M
	@23//@WHITE		        //if (Memory at keyboard address == 0) - meaning no key is pressed - go to WHITE, else go to BLACK
	D;JEQ
	@16//@BLACK
	0;JMP
...
(BLACK)		//16
	...
	@5//@LOOP              //jumps back to indexer in order to progress the index backwards.
	0;JMP
